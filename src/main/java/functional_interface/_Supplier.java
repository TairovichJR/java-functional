...
//Supplier is userd to return some value without taking any argument, like a getter method
public class _Supplier {
    ...
    static Supplier<List<String>> getDBConnectionUrlListSupplier = () ->
            List.of("jdbc://localhost:5432/users", "jdbc://localhost:5432/admins", "jdbc://localhost:5432/managers");
